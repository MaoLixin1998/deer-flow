...
function createCompatibleClient(isMock?: boolean): LangGraphClient {
  ...
  // 聊天主链路不是手写 fetch，而是复用 LangGraph JS SDK。
  // getLangGraphBaseURL() 指向 gateway 暴露的 LangGraph 兼容 API；
  // useStream/thread.submit 最终会落到 /api/threads/{threadId}/runs/stream。
